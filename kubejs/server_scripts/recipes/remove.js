ServerEvents.recipes(event => {
    ...
    event.remove({ id: 'enchanted:soft_clay_jar' })
    event.remove({ id: 'enchanted:witch_cauldron/mutandis' })
    event.remove({ id: 'enchanted:witch_oven' })
    ...
    event.remove({ id: 'nuclearcraft:assembler/plates_hsla_steel-basic_electric_circuit-lithium_ion_cell-coil_magnesium_diboride-actuator' })
